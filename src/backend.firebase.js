...
MM.Backend.Firebase.connect = function(server, auth) {
	// Initialize Firebase
	var config = {
		apiKey: "AIzaSyC1HqxIN8_zGZV1u_SoUxClhqH9JO3GTgo",
	    authDomain: "draw-mind.firebaseapp.com",
	    databaseURL: "https://draw-mind.firebaseio.com",
	    projectId: "draw-mind",
	    storageBucket: "draw-mind.appspot.com",
	    messagingSenderId: "784589587529",
	    appId: "1:784589587529:web:4d8fe67f9e2d21bfa06b98",
	    measurementId: "G-XCZP87SPNR"
	};
